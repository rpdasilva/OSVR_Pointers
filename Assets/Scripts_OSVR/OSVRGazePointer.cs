...
public class OSVRGazePointer : MonoBehaviour {
    ...
    private static OSVRGazePointer _instance;
    public static OSVRGazePointer instance 
    { 
        ...
        get
        {
            if (_instance == null)
            {
                ...
                _instance = (OSVRGazePointer)GameObject.Instantiate((OSVRGazePointer)Resources.Load("Prefabs/GazePointerRing", typeof(OSVRGazePointer)));
            }
            return _instance;
        }
	...
	void Update () {
        ...
        transform.position = cameraRig.gameObject.transform.position + cameraRig.gameObject.transform.forward * depth;
    ...
    public void SetPosition(Vector3 pos, Vector3 normal)
    {
        ...
        depth = (cameraRig.gameObject.transform.position - pos).magnitude;
    ...
    {
        SetPosition(pos, cameraRig.gameObject.transform.forward);
    }
    ...
    void LateUpdate()
    {
        ...
        if (positionSetsThisFrame == 0)
        {
            ...
            Quaternion newRot = transform.rotation;
            newRot.SetLookRotation(cameraRig.gameObject.transform.forward, (lastPosition - transform.position).normalized);
            transform.rotation = newRot;
        }
