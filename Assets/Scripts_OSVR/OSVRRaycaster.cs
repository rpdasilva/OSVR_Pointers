...
public class OSVRRaycaster : GraphicRaycaster, IPointerEnterHandler
{
    [Tooltip("A world space pointer for this canvas")]
    public GameObject pointer;
    

    protected OSVRRaycaster()
    { }
    ...
    /// <summary>
    /// Performs a raycast using the pointer object attached to this OSVRRaycaster 
    /// </summary>
    /// <param name="eventData"></param>
    /// <param name="resultAppendList"></param>
