...
namespace OSVR
{
    namespace Unity
    {
        ...
        public class OSVRMouseLookJoystick : MonoBehaviour
        {
            ...
            public RotationAxes axes = RotationAxes.RightJoystick;
            ...
            void Update()
            {
                ...
                {
                    if (Mathf.Abs(Input.GetAxis("Right Joystick X")) > 0.02f ||
                        Mathf.Abs(Input.GetAxis("Right Joystick Y")) > 0.02f)
                    {                     
                        float rotationX = transform.localEulerAngles.y + Input.GetAxis("Right Joystick X") * sensitivityX;
                        float rotationY = transform.localEulerAngles.x + Input.GetAxis("Right Joystick Y") * sensitivityY;
